    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center min-h-screen text-white px-4">
        ...
        <p className="max-w-3xl py-4 text-lg">
          DevCollab is a comprehensive real-time developer collaboration platform that combines code editing,
          project management, and communication features. This tool is designed to help you make collaborative
          projects.
        </p>
