            ...
            <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-none p-4 md:rounded-2xl md:p-6 bg-white/10 backdrop-blur-3xl">
                <form className="my-6" onSubmit={handleSubmit}>
                    ...
                    <LabelInputContainer className="mb-4">
                        ...
                        <Input id="email" name="email" placeholder="devcollab@email.com" type="email" value={formData.email} onChange={handleChange} required />
                    </LabelInputContainer>
                    <LabelInputContainer className="mb-4">
                    ...
                    <div className="flex flex-col space-y-4">
                        ...
                        >
                            Already have a account ? Log in &rarr;
                            <BottomGradient />
                        </button>
                    </div>
                </form>
