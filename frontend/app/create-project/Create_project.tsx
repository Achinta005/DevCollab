...
const Create_project = () => {
    ...
    return (
        <div className='relative min-h-screen'>
            ...
            ></div>
            <div className='bg-white/30 backdrop-blur-3xl rounded-lg p-2 text-amber-50 w-fit absolute left-5 top-5 active:scale-75 transition-transform duration-300 ease-in-out cursor-pointer' onClick={() => router.push('/')}>
                &larr;HOME
            </div>
            <div className='relative z-10 pt-24 mx-96'>
                ...
                <form className="my-6" onSubmit={handleSubmit}>
                    <div className="mb-2 flex flex-row space-y-0 space-x-2">
                        <LabelInputContainer>
                            <Label htmlFor="name" className='text-green-500 text-center text-md'>Project Name</Label>
                            <Input
                                id="name"
                                name="name"
                                type="text"
                    ...
                    <LabelInputContainer className="mb-2">
                        <Label htmlFor="description" className='text-green-500 text-center text-md'>Description</Label>
                        <Input
                            id="description"
                            name="description"
                    ...
                    <LabelInputContainer className="mb-2">
                        <Label htmlFor="visibility" className='text-green-500 text-center text-md'>Visibility</Label>
                        <select
                            id="visibility"
                            name="visibility"
                            value={formData.visibility}
                            onChange={handleChange}
                            className="border py-2 shadow-input dark:placeholder-text-neutral-600 flex h-10 w-full rounded-md border-none bg-gray-50 px-3 text-sm text-black transition duration-400 group-hover/input:shadow-none file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-neutral-400 focus-visible:ring-[2px] focus-visible:ring-neutral-400 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:bg-zinc-800 dark:text-white dark:shadow-[0px_0px_1px_1px_#404040] dark:focus-visible:ring-neutral-600"
                            required
                        >
